        ...
        {!submitted ? (
            ...
            <div className="md:w-5/12 bg-emerald-600 dark:bg-emerald-900/50 text-white p-10 flex flex-col justify-between">
              <div>
                ...
                <p className="text-emerald-100 dark:text-emerald-200 font-medium leading-relaxed">
                  Have questions about our global environmental logistics? Reach out to the WasteWise operations team today and help us build a cleaner planet.
                </p>
              </div>
              <div className="space-y-6 mt-12">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="font-bold tracking-wide">support@wastewise.com</span>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <p className="text-zinc-500 leading-relaxed mb-6">
              Thank you for contacting WasteWise. We have received your inquiry regarding <strong>{formData.subject}</strong> and will respond to <strong>{formData.email}</strong> shortly.
            </p>
