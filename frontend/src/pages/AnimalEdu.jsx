...
const AnimalEdu = () => {
  const animals = [
    ...
    },
    {
      ...
      tip: "Reduce your daily carbon footprint by utilizing WasteWise's optimized fleets.",
      color: "text-blue-400",
      bg: "bg-blue-900/20",
    ...
    <div className="min-h-screen bg-[#09090b] p-6 text-zinc-200">
      <div className="max-w-6xl mx-auto mt-8 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          >
            Every piece of waste you recycle through WasteWise directly impacts the survival of these beautiful creatures.
          </motion.p>
        </div>
        ...
        >
          <div className="text-center mb-12 relative z-10">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              Our planet is facing unprecedented destruction. The metrics below highlight exactly why WasteWise's mission is critical to our survival.
            </p>
          </div>
