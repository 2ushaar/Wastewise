...
const Dashboard = () => {
  ...
  const MISSIONS = [
    ...
    { title: "Calculate 5 WasteWise Routes", progress: 0, target: "0/5 Done", points: "+20 XP" },
  ];
      ...
      <div className="max-w-7xl mx-auto space-y-8">
          ...
          >
            <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mb-6 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="text-emerald-500 animate-[ping_2s_infinite]">●</span> WasteWise Spatial Analyzer
              </div>
        ...
        >
          <div className="text-center mb-10 max-w-2xl mx-auto">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-lg">WasteWise is built to protect native ecosystems by actively removing hazardous waste and plastics from vulnerable zones.</p>
          </div>
        ...
        >
          <div className="md:w-1/2 p-10 md:p-14 flex flex-col justify-center relative z-10 bg-white/40 dark:bg-zinc-900/80 backdrop-blur-sm">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-lg leading-relaxed font-medium">
              Every single piece of hazardous waste you report and recycle through WasteWise directly ensures a safer, cleaner, and healthier planet.
              <br /><br />
